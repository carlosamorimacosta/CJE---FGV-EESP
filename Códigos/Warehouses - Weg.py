### Este código foi feito para traçar a localização da WEG e MARATHON (empresa de motores e geradores elétricos pertencente a WEG.SA), NIDEC e SCHNEIDER. Mas também os principais centros de Inteligência Artificial nos EUA.
...
warehouses = [
    ...
    {"Warehouse Name": "Marathon Electric, LLC", "Latitude": 39.8035, "Longitude": -86.395, "Segments": "Generator, Electric Motor", "Empresa": "WEG e Marathon"},
    ...
    {"Warehouse Name": "Marathon (INC)", "Latitude": 35.4737, "Longitude": -80.6843, "Segments": "Generator, Electric Motor", "Empresa": "WEG e Marathon"},
    ...
    {"Warehouse Name": "WEG PROUD WAREHOUSE - WASHINGTON", "Latitude": 47.3997, "Longitude": -122.2348, "Segments": "Generator, Electric Motor", "Empresa": "WEG e Marathon"},
    {"Warehouse Name": "WEG PROUD WAREHOUSE - CALIFORNIA", "Latitude": 34.0634, "Longitude": -117.6200, "Segments": "Generator, Electric Motor", "Empresa": "WEG e Marathon"},
    {"Warehouse Name": "WEG PROUD WAREHOUSE - TEXAS", "Latitude": 30.0121, "Longitude": -95.4266, "Segments": "Generator, Electric Motor", "Empresa": "WEG e Marathon"},
    {"Warehouse Name": "WEG PROUD WAREHOUSE - KANSAS", "Latitude": 39.1135, "Longitude": -94.8142, "Segments": "Generator, Electric Motor", "Empresa": "WEG e Marathon"},
    {"Warehouse Name": "WEG PROUD WAREHOUSE - ILLINOIS", "Latitude": 41.6450, "Longitude": -88.1024, "Segments": "Generator, Electric Motor", "Empresa": "WEG e Marathon"},
    {"Warehouse Name": "WEG PROUD WAREHOUSE - PENNSYLVANIA", "Latitude": 40.2365, "Longitude": -77.0805, "Segments": "Generator, Electric Motor", "Empresa": "WEG e Marathon"},
    {"Warehouse Name": "WEG PROUD WAREHOUSE - GEORGIA", "Latitude": 34.0806, "Longitude": -84.0890, "Segments": "Generator, Electric Motor", "Empresa": "WEG e Marathon"},
]

# Schneider Electric warehouses
schneider_warehouses = [
    {"Warehouse Name": "Schneider Electric (TVA)", "Latitude": 32.2205, "Longitude": -95.8306, "Segments": "Power Distribution, Industrial Automation", "Empresa": "Schneider Electric"},
    {"Warehouse Name": "Schneider Electric (TNI)", "Latitude": 36.2008, "Longitude": -86.5186, "Segments": "Switchgear, Medium Voltage Equipment", "Empresa": "Schneider Electric"},
    {"Warehouse Name": "Schneider Electric (CAC)", "Latitude": 34.0922, "Longitude": -117.4350, "Segments": "Electric Industrial Distribution, Data Center Solutions", "Empresa": "Schneider Electric"},
    {"Warehouse Name": "Schneider Electric (GAP)", "Latitude": 32.1174, "Longitude": -81.1526, "Segments": "Logistics Hub, Electrical Components", "Empresa": "Schneider Electric"},
    {"Warehouse Name": "Schneider Electric (IAI)", "Latitude": 41.6903, "Longitude": -93.7918, "Segments": "Power Systems, Smart Grid Components", "Empresa": "Schneider Electric"},
    {"Warehouse Name": "Schneider Electric (NN)", "Latitude": 39.5296, "Longitude": -119.8138, "Segments": "Energy Management, Automation Solutions", "Empresa": "Schneider Electric"},
    {"Warehouse Name": "Schneider Electric (VNI)", "Latitude": 36.6468, "Longitude": -76.2859, "Segments": "Backup Power, Grid Distribution", "Empresa": "Schneider Electric"},
    {"Warehouse Name": "Schneider Electric (VNI)", "Latitude": 40.5565, "Longitude": -74.2551, "Segments": "Distribution Equipment, Electrical Panels", "Empresa": "Schneider Electric"},
    {"Warehouse Name": "Schneider Electric (VAT)", "Latitude": 47.2529, "Longitude": -122.4443, "Segments": "Automation Systems, Control Panels", "Empresa": "Schneider Electric"},
]

# Nidec warehouses
nidec_warehouses = [
    {"Warehouse Name": "Advanced Motors & Drives (Sales Office)", "Latitude": 43.8957, "Longitude": -76.0590, "Segments": "Special purpose AC, DC and brushless DC motors", "Empresa": "Nidec"},
    {"Warehouse Name": "NIDEC Motor CORPORATION ISL (MIDDELPORT)", "Latitude": 41.6800, "Longitude": -80.5600, "Segments": "Special Purpose AC, DC and brushless DC motors", "Empresa": "Nidec"},
    {"Warehouse Name": "NIDEC Motor Corporation NIS US", "Latitude": 41.4308, "Longitude": -81.6650, "Segments": "", "Empresa": "Nidec"},
    ...
    {"Warehouse Name": "NIDEC CORPORATION NEMA", "Latitude": 33.7249, "Longitude": -92.0763, "Segments": "", "Empresa": "Nidec"},
    {"Warehouse Name": "NIDEC GENMARK AUTOMATION, INC.", "Latitude": 37.5485, "Longitude": -121.9886, "Segments": "Manufacture and sale of high-precision robotics for the semiconductor, data storage, and flat panel display industries.", "Empresa": "Nidec"},
]

# Combine all warehouses
warehouses.extend(schneider_warehouses)
warehouses.extend(nidec_warehouses)
...
data_centers = [
    ...
    {"City": "Phoenix", "Latitude": 33.4484, "Longitude": -112.074, "Segment": "Primary markets"},
    ...
    {"City": "Kansas", "Latitude": 30.0558, "Longitude": -95.689, "Segment": "Secondary markets"},
    ...
    {"City": "South Carolina", "Latitude": 34.0007, "Longitude": -91.0384, "Segment": "Secondary markets"},
...
# ============================================================================
# 3. FUNÇÃO PARA CALCULAR DISTÂNCIA HAVERSINE (km)
# ============================================================================
...
# ============================================================================
# 4. CÁLCULO DA DISTÂNCIA MÉDIA POR EMPRESA E CATEGORIA DE DATA CENTER
# ============================================================================
...
print("=" * 60)
print("DISTÂNCIA MÉDIA POR EMPRESA E CATEGORIA DE DATA CENTER")
print("=" * 60)
...
grupo_schneider = folium.FeatureGroup(name='Warehouses - Schneider')
...
<i style="color:orange">●</i> Emerging markets<br>
</div>
"""
...
print(f"Mapa salvo em: {os.path.abspath(map_path)}")
